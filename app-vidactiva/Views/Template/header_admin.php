...
<head>
  <meta charset="utf-8">
  <meta name="description" content="Sistema Electoral">
  ...
  <!-- Main CSS-->
  <link rel="stylesheet" type="text/css" href="<?= media(); ?>/css/main.css?v=3">
...
<body class="app sidebar-mini">
  <!-- Navbar-->
  <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Sistema Electoral</a>
    ...
    <ul class="app-nav">
      <!-- Ver Sitio Web -->
      <li>
        <a class="app-nav__item" href="http://localhost/encuestas" target="_blank" title="Ir al Sitio Web">
