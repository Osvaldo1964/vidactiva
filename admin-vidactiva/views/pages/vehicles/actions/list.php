...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            <a class="btn bg-info btn-sm" href="/vehicles/autonew">Carga por Lotes</a>
            <a class="btn bg-info btn-sm" href="/vehicles/manualnew">Nuevo Vehículo</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableVehicles">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Placa</th>
