            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control numDocumento" onchange="validateJS(event,'number')" name="phone" required>
                    </div>
            ...
            <div class="form-row col-md-12 d-flex flex-row justify-content-center">
                ...
                <div class="form-group col-md-2 border border-primary">
                    ...
                    <div class="custom-file">
                        ...
                        <p id="msgId" style="color: red; display: none;">El archivo excede el tamaño permitido (5MB).</p>
                    </div>
                </div>
                ...
                <div class="form-group col-md-2 border border-info">
                    ...
                    <div class="custom-file">
                        ...
                        <p id="msgHv" style="color: red; display: none;">El archivo excede el tamaño permitido (5MB).</p>
                    </div>
                </div>
                ...
                <div class="form-group col-md-2 border border-primary">
                    ...
                    <div class="custom-file">
                        ...
                        <p id="msgFm" style="color: red; display: none;">El archivo excede el tamaño permitido (5MB).</p>
                    </div>
                </div>
                ...
                <div class="form-group col-md-2 border border-info">
                    ...
                    <div class="custom-file">
                        ...
                        <p id="msgEx" style="color: red; display: none;">El archivo excede el tamaño permitido (5MB).</p>
                    </div>
                </div>
                ...
                <div class="form-group col-md-2 border border-info">
                    ...
                    <div class="custom-file">
                        ...
                        <p id="msgRs" style="color: red; display: none;">El archivo excede el tamaño permitido (5MB).</p>
                    </div>
                </div>
            </div>
