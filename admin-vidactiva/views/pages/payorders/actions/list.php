...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            <a class="btn bg-info btn-sm" href="/payorders/autonew">Generar Mandamientos Lotes</a>
            <a class="btn bg-info btn-sm" href="/payorders/manualnew">Generar Mandamientos Manual</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tablePayorders">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Tipo</th>
