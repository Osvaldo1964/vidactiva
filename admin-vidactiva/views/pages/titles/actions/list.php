...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            <a class="btn bg-info btn-sm" href="/titles/autonew">Cargar Titulos por Lotes</a>
            <a class="btn bg-info btn-sm" href="/titles/manualnew">Generar Titulo Manual</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableTitles">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Número</th>
