...
<div class="card">
    <div class="card-header">
        ...
        ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm" href="/formers/new">Nuevo Formador</a>
            </h3>
        <?php } else { ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm disabled" href="#" tabindex="-1" aria-disabled="true">Nuevo Formador</a>
            </h3>
        <?php } ?>
        <h3 class="card-title ml-3">
            <a class="btn bg-info btn-sm" onclick="former_excel()">Enviar Excel</a>
        </h3>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableFormers">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Número Doc.</th>
