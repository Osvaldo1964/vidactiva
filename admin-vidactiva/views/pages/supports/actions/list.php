...
<div class="card">
    <div class="card-header">
        ...
        ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm" href="/supports/new">Nuevo Empleado</a>
            </h3>
        <?php } else { ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm disabled" href="#" tabindex="-1" aria-disabled="true">Nuevo Empleado</a>
            </h3>
        <?php } ?>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableSupports">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Número Doc.</th>
