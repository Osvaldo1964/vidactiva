            ...
            <div class="form-row col-md-12 mt-2">
                ...
                <div class="input-group col-md-7">
                    ...
                    <div id="selectMultipleCheckbox" class="form-control d-flex flex-wrap" style="height: auto;">
                        ...
                        <div class="form-check me-3">
                            <input class="form-check-input" type="checkbox" value="otras" id="option6" name="morbil_student[]">
                            <label class="form-check-label" for="option6">Otras</label>
                        </div>
                        <div class="form-check me-2">
                            <input class="form-check-input" type="checkbox" value="nomorbil" id="option7" name="morbil_student[]">
            ...
            <div class="form-row col-md-12 mt-2">
                ...
                <div class="input-group col-md-7">
                    ...
                    <div id="selectMultipleCheckbox" class="form-control d-flex flex-wrap" style="height: auto;">
                        ...
                        <div class="form-check me-2">
                            <input class="form-check-input" type="checkbox" value="nodiscap" id="option6" name="tipdiscap_student[]">
