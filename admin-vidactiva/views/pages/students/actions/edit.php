...
if (isset($routesArray[3])) {
    ...
    if ($security[1] == $_SESSION["user"]->token_user) {
        ...
        $url = "relations?rel=students,departments,municipalities,schools&type=student,department,municipality,school&select=" .
            $select . "&linkTo=id_student&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
        ...
        $directory = "views/img/students/" . $files->name_department . "/" . $files->name_municipality . "/" .
            $files->name_school . "/" . $files->document_student . "/";
        ...
        $filePrefixes = ['ft', 'rd', 'ep', 'ac', 'cs', 'cv'];
        $uploadedFiles = [];

        foreach ($filePrefixes as $prefix) {
            $filePath = $directory . $prefix . '_' . $files->id_student . '.pdf';
            $uploadedFiles[$prefix] = file_exists($filePath) ? $filePath : $defaultFile;
        }

        $upfileft = $uploadedFiles['ft'];
        $upfilerd = $uploadedFiles['rd'];
        $upfileep = $uploadedFiles['ep'];
        $upfileac = $uploadedFiles['ac'];
        $upfilecs = $uploadedFiles['cs'];
        $upfilecv = $uploadedFiles['cv'];
...
<div class="card card-dark card-outline col-md-12">
    <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
        ...
        <input type="hidden" value="<?php echo $files->name_department ?>" name="nameDpto" id="nameDpto">
        <input type="hidden" value="<?php echo $files->name_municipality ?>" name="nameMuni" id="nameMuni">
        <input type="hidden" value="<?php echo $files->name_school ?>" name="nameIed" id="nameIed">
        ...
        <div class="card-body">
            ...
            <div class="form-row col-md-12 mt-2">
                ...
                <div class="input-group col-md-2">
                    ...
                    <input type="number" class="form-control valDocumento numDocumento"
                        ...
                        onchange="validateRepeat(event,'num','students','document_student')" required>
                    ...
                    <select class="form-select" name="placedoc_student" id="placedoc_student" required>
                        <?php for ($i = 0; $i < count($muniexp); $i++) { ?>
                            <?php if ($muniexp[$i]["name"] == $students->placedoc_student) : ?>
                                <option value="<?php echo $students->placedoc_student ?>" selected><?php echo $students->placedoc_student ?></option>
                            <?php else : ?>
                    ...
                    <select class="form-select" name="place_birth_student" id="place_birth_student" required>
                        <?php for ($i = 0; $i < count($muninac); $i++) { ?>
                            <?php if ($muninac[$i]["name"] == $students->place_birth_student) : ?>
                                <option value="<?php echo $students->place_birth_student ?>" selected><?php echo $students->place_birth_student ?></option>
                            <?php else : ?>
            ...
            <div class="form-row col-md-12 mt-2">
                ...
                <div class="input-group col-md-2">
                    ...
                    <input type="number" class="form-control valDocumento numDocumento" onchange="validateJS(event,'num')"
                        value="<?php echo $students->phone_student ?>" name="phone_student" id="phone_student" required>
                </div>
            </div>
            <div class="form-row col-md-12 mt-2">
                <!-- Email -->
            ...
            <div class="form-row col-md-12 mt-2">
                ...
                <div class="input-group col-md-7">
                    <label for="selectMultipleCheckbox" class="input-group-text form-label">Condición: </label>
                    <div id="selectMultipleCheckbox" class="form-control d-flex flex-wrap" style="height: auto;">
                        ...
                        <div class="form-check me-3">
                            <input class="form-check-input" type="checkbox" value="otras" <?php if (in_array("otras", $morbil)) echo "checked"; ?>
                                id="option6" name="morbil_student[]">
                            <label class="form-check-label" for="option6">Otras</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="checkbox" value="nomorbil" <?php if (in_array("nomorbil", $morbil)) echo "checked"; ?>
                                id="option7" name="morbil_student[]">
                            <label class="form-check-label" for="option7">NA</label>
                        </div>
                    </div>
                </div>
                <!-- Otro -->
            ...
            <div class="form-row col-md-12 mt-2">
                <!-- Discapacidades -->
                <div class="input-group col-md-6">
                    <label for="selectMultipleCheckbox" class="input-group-text form-label">Discapacidad: </label>
                    <div id="selectMultipleCheckbox" class="form-control d-flex flex-wrap" style="height: auto;">
                        ...
                        <div class="form-check me-2">
                            <input class="form-check-input" type="checkbox" value="nodiscap" <?php if (in_array("nodiscap", $tipdiscap)) echo "checked"; ?>
                                id="option6" name="tipdiscap_student[]">
                            <label class="form-check-label" for="option6">NA</label>
                        </div>
                    </div>
                </div>
                <!-- Otro -->
            ...
            <div class="form-row col-md-12">
                <div class="form-row col-md-12">
                    ...
                    <!-- Registro -->
                    <div class="form-group col-md-2 border border-primary">
                        <label>Documento Focalización</label>
                    ...
                    <!-- Registro Civil -->
                    <div class="form-group col-md-2 border border-primary">
                        <label>Reg. Civil/T.I. Beneficiario</label>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="form-group">
                    ...
                    if (
                        ...
                        || $_SESSION["rols"]->name_class == "FORMADOR"
                    ) {
                    ?>
