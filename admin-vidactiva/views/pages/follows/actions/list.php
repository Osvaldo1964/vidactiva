...
<div class="card">
    <div class="card-header">
        ...
        ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm" href="/follows/new">Abrir Seguimiento CID</a>
            </h3>
        <?php } else { ?>
            <h3 class="card-title">
                <a class="btn bg-info btn-sm disabled" href="#" tabindex="-1" aria-disabled="true">Abrir Seguimiento CID</a>
            </h3>
        <?php } ?>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="adminsTable" class="table table-bordered table-striped tableFollows">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Departamento</th>
        ...
        <div class="modal-content">
            <form method="post" class="needs-validation" novalidate>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    $payorderUpdate = new FollowsController();
                    $payorderUpdate->followUpdate();
                    ?>
