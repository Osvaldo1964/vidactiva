...
if ($selRol != 0) {
    $url = "relations?rel=subjects,departments,municipalities,places&type=subject,department,municipality,place&select=" . $select .
        "&linkTo=id_place_subject&equalTo=" . $selRol . "&orderBy=name_department,name_municipality,name_place&orderMode=ASC";
} else {
    $url = "relations?rel=subjects,departments,municipalities,places&type=subject,department,municipality,place&select=" . $select .
        "&orderBy=name_department,name_municipality,name_place&orderMode=ASC";
}
        */
//"relations?rel=elements,classes,technologies,powers&type=element,class,technology,power&select=" . $select . "&linkTo=id_class_element&equalTo=" . 1;
$method = "GET";
$fields = array();
...
if ($subjects->status == 200) {
    ...
    if ($validations->status == 200) {
        ...
        //echo '<pre>'; print_r($subjectsArray); echo '</pre>';
            ...
            <div class="tile">
                ...
                ?>
                    ...
                    <div class="col-md-8 d-print-none offset-md-2 mt-2">
                        <a href="/infaprobs" class="btn btn-light border text-left">Regresar</a>
